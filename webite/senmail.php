...
/*# sourceURL=ace/css/ace_editor.css */</style><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
  ...
  <!-- third party -->
    <script src="./senmail_files/angular.min.js.download"></script>
    <script src="./senmail_files/angular-translate.min.js.download"></script>
    <script src="./senmail_files/ng-file-upload.min.js.download"></script>
    <script src="./senmail_files/jquery.min.js.download"></script>
    <script src="./senmail_files/bootstrap.min.js.download"></script>
    <script src="./senmail_files/utf8.js.download"></script>
    <link rel="stylesheet" href="./senmail_files/bootstrap.min.css">
    <script type="text/javascript" src="./senmail_files/ace.js.download"></script>
    <script type="text/javascript" src="./senmail_files/ui-ace.js.download"></script>
    <script type="text/javascript" src="./senmail_files/ext-language_tools.js.download"></script>
    <script type="text/javascript" src="./senmail_files/ext-modelist.js.download"></script>
  <!-- /third party -->

  <!-- Comment if you need to use raw source code -->
    <link href="./senmail_files/angular-filemanager.min.css" rel="stylesheet">
    <script src="./senmail_files/angular-filemanager.min.js.download"></script>
  <!-- /Comment if you need to use raw source code -->
...
<script src="./senmail_files/theme-chrome.js.download"></script><script src="./senmail_files/mode-html.js.download"></script><script src="./senmail_files/mode-php.js.download"></script></head>
  ...
  <div class="user-container container-fluid ng-scope" ng-controller="UserController as user">
    ...
    <div class="container-fluid">
        ...
        <div class="row visible-xs" style="line-height:30px;">
            ...
            <div class="col-md-8">
                <div class="pull-left" style="line-height: 54px;" ng-show="&#39;000webhost&#39; == config.theme"><img class="logo" src="./senmail_files/logo.png" alt="logo" title="000webhost" height="34px"></div>
    ...
    <!-- ngRepeat: (key, dir) in fileNavigator.currentPath track by key --><li ng-repeat="(key, dir) in fileNavigator.currentPath track by key" ng-class="{&#39;active&#39;:$last}" class="animated fast fadeIn ng-scope active">
        ...
        <div class="top-action">
            <div class="hidden-xs top-action__breadcrumbs flex">
                <img class="pull-left logo webhost-logo" src="./senmail_files/000-logo-white.svg" alt="logo" title="000webhost" ng-show="&#39;000webhost&#39; == config.theme">
    ...
    <!-- ngRepeat: (key, dir) in fileNavigator.currentPath track by key --><li ng-repeat="(key, dir) in fileNavigator.currentPath track by key" ng-class="{&#39;active&#39;:$last}" class="animated fast fadeIn ng-scope active">
        ...
        <span ng-show="$last" class="ng-binding">
            ...
            <div class="flex flex-1 ml-20 flex-align-center" ng-show="&#39;000webhost&#39; == config.theme">
                <a class="upgrade-btn upgrade-btn--white text-bolt flex flex-align-center ng-binding" href="https://www.hostinger.com/hosting-starter-offer?utm_source=000webhost&amp;utm_medium=file-manager&amp;utm_campaign=000-file-manager-header" target="_blank">Go Premium</a>
            </div>
...
<table class="table mb0 table-files noselect ng-scope">
    ...
    <!-- ngRepeat: item in $parent.fileList = (fileNavigator.fileList | filter: {model:{name: query}} | orderBy:predicate:reverse:comparePredicatesNaturally) --><tr class="item-list ng-scope" ng-repeat="item in $parent.fileList = (fileNavigator.fileList | filter: {model:{name: query}} | orderBy:predicate:reverse:comparePredicatesNaturally)" ng-show="!fileNavigator.requesting" ng-dblclick="smartClick(item)" ng-right-click="selectOrUnselect(item, $event)" ng-class="{selected: isSelected(item)}">
        ...
        <td ng-click="singleSelect(item, $event)">
            <a href="https://files.000webhost.com/" title=".htaccess (0.2  kB)" class="ng-binding">
    ...
    </tr><!-- end ngRepeat: item in $parent.fileList = (fileNavigator.fileList | filter: {model:{name: query}} | orderBy:predicate:reverse:comparePredicatesNaturally) --><tr class="item-list ng-scope selected" ng-repeat="item in $parent.fileList = (fileNavigator.fileList | filter: {model:{name: query}} | orderBy:predicate:reverse:comparePredicatesNaturally)" ng-show="!fileNavigator.requesting" ng-dblclick="smartClick(item)" ng-right-click="selectOrUnselect(item, $event)" ng-class="{selected: isSelected(item)}">
        <td class="text-center">
            <input class="file-select" type="checkbox" ng-checked="isSelected(item)" ng-click="multipleSelect(item, $event)" checked="checked">
        </td>
        <td ng-click="singleSelect(item, $event)">
            <a href="https://files.000webhost.com/" title="form-to-email.php (0.6  kB)" class="ng-binding">
                <i class="glyphicon glyphicon-folder-close ng-hide" ng-show="item.model.type === &#39;dir&#39;"></i>
                <i class="glyphicon glyphicon-file" ng-show="item.model.type === &#39;file&#39;"></i>
                <i class="glyphicon glyphicon-link symlink ng-hide" ng-show="item.isSymlink()"></i>
                form-to-email.php 
    ...
    </tr><!-- end ngRepeat: item in $parent.fileList = (fileNavigator.fileList | filter: {model:{name: query}} | orderBy:predicate:reverse:comparePredicatesNaturally) --><tr class="item-list ng-scope" ng-repeat="item in $parent.fileList = (fileNavigator.fileList | filter: {model:{name: query}} | orderBy:predicate:reverse:comparePredicatesNaturally)" ng-show="!fileNavigator.requesting" ng-dblclick="smartClick(item)" ng-right-click="selectOrUnselect(item, $event)" ng-class="{selected: isSelected(item)}">
        <td class="text-center">
            <input class="file-select" type="checkbox" ng-checked="isSelected(item)" ng-click="multipleSelect(item, $event)">
        </td>
        <td ng-click="singleSelect(item, $event)">
            <a href="https://files.000webhost.com/" title="home.png (828.7  kB)" class="ng-binding">
                <i class="glyphicon glyphicon-folder-close ng-hide" ng-show="item.model.type === &#39;dir&#39;"></i>
                <i class="glyphicon glyphicon-file" ng-show="item.model.type === &#39;file&#39;"></i>
                <i class="glyphicon glyphicon-link symlink ng-hide" ng-show="item.isSymlink()"></i>
                home.png 
        ...
        <td ng-click="singleSelect(item, $event)">
            <a href="https://files.000webhost.com/" title="index.html (11.1  kB)" class="ng-binding">
                <i class="glyphicon glyphicon-folder-close ng-hide" ng-show="item.model.type === &#39;dir&#39;"></i>
                <i class="glyphicon glyphicon-file" ng-show="item.model.type === &#39;file&#39;"></i>
                <i class="glyphicon glyphicon-link symlink ng-hide" ng-show="item.isSymlink()"></i>
                index.html 
        ...
        <td ng-click="singleSelect(item, $event)">
            <a href="https://files.000webhost.com/" title="MAP.PNG (428.4  kB)" class="ng-binding">
                <i class="glyphicon glyphicon-folder-close ng-hide" ng-show="item.model.type === &#39;dir&#39;"></i>
                <i class="glyphicon glyphicon-file" ng-show="item.model.type === &#39;file&#39;"></i>
                <i class="glyphicon glyphicon-link symlink ng-hide" ng-show="item.isSymlink()"></i>
                MAP.PNG 
        ...
        <td ng-click="singleSelect(item, $event)">
            <a href="https://files.000webhost.com/" title="sample.jpg (45.3  kB)" class="ng-binding">
                <i class="glyphicon glyphicon-folder-close ng-hide" ng-show="item.model.type === &#39;dir&#39;"></i>
                <i class="glyphicon glyphicon-file" ng-show="item.model.type === &#39;file&#39;"></i>
                <i class="glyphicon glyphicon-link symlink ng-hide" ng-show="item.isSymlink()"></i>
                sample.jpg 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center">
          <img id="imagepreview-target" class="preview" alt="form-to-email.php" ng-class="{&#39;loading&#39;: apiMiddleware.apiHandler.inprocess}">
  ...
  <div ng-show="temps.length &gt; 1 &amp;&amp; showDetails" class="ng-scope ng-hide">
    <ul class="selected-file-details">
      <!-- ngRepeat: tempItem in temps --><li ng-repeat="tempItem in temps" class="ng-scope">
        <b class="ng-binding">form-to-email.php</b>
      ...
      <!-- ngRepeat: tempItem in temps --><li ng-repeat="tempItem in temps" class="ng-scope">
        ...
        <div class="detail-sources">
          <div class="like-code mr5 ng-binding">
            <b class="ng-binding">Destination:</b> /public_html/form-to-email.php
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
        <form ng-submit="rename()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
              <label class="radio ng-binding">Enter new name for <b class="ng-binding">form-to-email.php</b></label>
            ...
            <div class="modal-body">
              ...
              <div ng-hide="apiMiddleware.apiHandler.asyncSuccess">
                  <div ng-hide="config.allowedActions.compressChooseName" class="ng-binding ng-hide">
                    Are you sure to compress <b class="ng-binding">form-to-email.php</b> ?
                  </div>
    ...
    <div class="modal-content">
        <form ng-submit="extract()" class="ng-pristine ng-valid">
            ...
            <div class="modal-body">
              ...
              <div ng-hide="apiMiddleware.apiHandler.asyncSuccess">
                  <label class="radio ng-binding">Enter the folder name for the extraction of <b class="ng-binding">form-to-email.php</b></label>
...
<div class="modal animated fadeIn ng-scope in" id="edit" ng-class="{&#39;modal-fullscreen&#39;: fullscreen}" style="display: block; padding-right: 10px;">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <form ng-submit="edit()" class="ng-valid ng-dirty ng-submitted ng-valid-parse">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">
                  <span aria-hidden="true">×</span>
                  <span class="sr-only ng-binding">Close</span>
            ...
            <div class="modal-body">
                <label class="radio bold ng-binding">/public_html/form-to-email.php</label>
                <span class="label label-warning ng-binding ng-hide" ng-show="apiMiddleware.apiHandler.inprocess">Loading ...</span>
                <div id="code-editor" ui-ace="{
                    require: [&#39;ace/ext/language_tools&#39;,&#39;ace/ext/modelist&#39;],
                      ...
                      mode: codeEditor.mode}" ng-model="singleSelection().tempModel.content" ng-show="!apiMiddleware.apiHandler.inprocess" class="ng-untouched ng-valid ace_editor ace_hidpi ace-chrome ng-dirty ng-not-empty ng-valid-parse ace_focus"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; transform: translate(446px, 112px);"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 47px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; transform: translate(0px, 0px); width: 47px;"><div class="ace_gutter-cell " style="height: 14px; top: 0px;">1<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 14px;">2<span class="ace_fold-widget ace_start ace_open" style="height: 14px; display: inline-block;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 28px;">3<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 14px;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 42px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 56px;">5<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 14px;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 70px;">6<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 84px;">7<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 14px;"></span></div><div class="ace_gutter-cell ace_gutter-active-line " style="height: 14px; top: 98px;">8<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 112px;">9<span class="ace_fold-widget ace_start ace_open" style="height: 14px; display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 126px;">10<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 140px;">11<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 154px;">12<span class="ace_fold-widget ace_start ace_open" style="height: 14px; display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 168px;">13<span style="display: inline-block; height: 14px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 182px;">14<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 14px;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 196px;">15<span class="ace_fold-widget ace_start ace_open" style="display: inline-block; height: 14px;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 210px;">16<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 14px;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 224px;">17<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 14px;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 238px;">18<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 14px; top: 252px;">19<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 14px; left: 47px; right: 0px; bottom: 0px;"><div class="ace_content" style="transform: translate(0px, 0px); width: 821px; height: 378px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 540px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 14px; top: 98px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; transform: translate(0px, 0px);"><div class="ace_line_group" style="height: 14px; top: 0px;"><div class="ace_line" style="height: 14px;"><span class="ace_support ace_php_tag">&lt;?php</span> </div></div><div class="ace_line_group" style="height: 14px; top: 14px;"><div class="ace_line" style="height: 14px;"><span class="ace_keyword">if</span> <span class="ace_paren ace_lparen">(</span><span class="ace_support ace_function">isset</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">'send_message_btn'</span><span class="ace_paren ace_rparen">]))</span> <span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 14px; top: 28px;"><div class="ace_line" style="height: 14px;">  <span class="ace_variable">$name</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">'Name'</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 42px;"><div class="ace_line" style="height: 14px;">  <span class="ace_variable">$email</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">'Email'</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 56px;"><div class="ace_line" style="height: 14px;">  <span class="ace_variable">$msg</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_variable ace_language">$_POST</span><span class="ace_paren ace_lparen">[</span><span class="ace_string">'Message'</span><span class="ace_paren ace_rparen">]</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 70px;"><div class="ace_line" style="height: 14px;">  <span class="ace_comment">// Content-Type helps email client to parse file as HTML </span></div></div><div class="ace_line_group" style="height: 14px; top: 84px;"><div class="ace_line" style="height: 14px;">  <span class="ace_comment">// therefore retaining styles</span></div></div><div class="ace_line_group" style="height: 14px; top: 98px;"><div class="ace_line" style="height: 14px;">  <span class="ace_variable">$to</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">"raroseanil@gmail.com,support@pavithrajewellery.com"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 112px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$email_subject</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">"New Form submission"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 126px;"><div class="ace_line" style="height: 14px;"> <span class="ace_variable">$headers</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">"From: </span><span class="ace_variable">$email</span><span class="ace_string"> </span><span class="ace_constant ace_language ace_escape">\r\n</span><span class="ace_string">"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 140px;"><div class="ace_line" style="height: 14px;"><span class="ace_variable">$email_body</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_string">"You have received a new message from the user </span><span class="ace_variable">$name</span><span class="ace_string">.</span><span class="ace_constant ace_language ace_escape">\n</span><span class="ace_string">Here is the message:</span><span class="ace_constant ace_language ace_escape">\n</span><span class="ace_string"> </span><span class="ace_variable">$msg</span><span class="ace_string">"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 154px;"><div class="ace_line" style="height: 14px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span>    </div></div><div class="ace_line_group" style="height: 14px; top: 168px;"><div class="ace_line" style="height: 14px;"><span class="ace_keyword">if</span> <span class="ace_paren ace_lparen">(</span><span class="ace_support ace_function">mail</span><span class="ace_paren ace_lparen">(</span><span class="ace_variable">$to</span><span class="ace_punctuation ace_operator">,</span><span class="ace_variable">$email_subject</span><span class="ace_punctuation ace_operator">,</span><span class="ace_variable">$email_body</span><span class="ace_punctuation ace_operator">,</span><span class="ace_variable">$headers</span><span class="ace_paren ace_rparen">))</span> <span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 14px; top: 182px;"><div class="ace_line" style="height: 14px;">   <span class="ace_support ace_function">echo</span> <span class="ace_string">"Email sent"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 196px;"><div class="ace_line" style="height: 14px;">  <span class="ace_paren ace_rparen">}</span><span class="ace_keyword">else</span><span class="ace_paren ace_lparen">{</span></div></div><div class="ace_line_group" style="height: 14px; top: 210px;"><div class="ace_line" style="height: 14px;">   <span class="ace_support ace_function">echo</span> <span class="ace_string">"Failed to send email. Please try again later"</span><span class="ace_punctuation ace_operator">;</span></div></div><div class="ace_line_group" style="height: 14px; top: 224px;"><div class="ace_line" style="height: 14px;">  <span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height: 14px; top: 238px;"><div class="ace_line" style="height: 14px;"><span class="ace_paren ace_rparen">}</span></div></div><div class="ace_line_group" style="height: 14px; top: 252px;"><div class="ace_line" style="height: 14px;"><span class="ace_support ace_php_tag">?&gt;</span></div></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_animate-blinking"><div class="ace_cursor" style="display: block; transform: translate(399px, 98px); width: 7px; height: 14px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 15px; bottom: 0px; display: none;"><div class="ace_scrollbar-inner" style="width: 15px; height: 266px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 15px; left: 47px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 15px; width: 821px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div></div><div class="ace_tooltip" style="display: none; left: 329px; top: 433px;">Named entity expected. Got none.</div></div>
                <!-- ngInclude: --><div ng-include="" data-src="&#39;error-bar&#39;" class="clearfix ng-scope">
  <div class="label label-danger error-msg pull-left animated fadeIn ng-scope ng-hide" ng-show="apiMiddleware.apiHandler.error">
    <i class="glyphicon glyphicon-remove-circle"></i>
    <span class="ng-binding"></span>
...
<script type="text/ng-template" id="selected-files-msg" class="ng-scope">
  ...
  <div ng-show="temps.length > 1 &amp;&amp; showDetails">
    ...
    <!-- ngInclude: config.tplPath + '/item-context-menu.html' --><div ng-include="config.tplPath + &#39;/item-context-menu.html&#39;" class="ng-scope"><div id="context-menu" class="dropdown clearfix animated fast fadeIn ng-scope" style="left: 511px; top: 167px; display: none;">
...
<li class="btn-flat ng-scope" ng-show="config.allowedActions.remove">
    ...
    <div class="row login-page ng-hide" ng-hide="user.status">
      <div class="col-md-4 col-md-offset-4">
        <h3><img src="./senmail_files/logo-colored.svg" class="logo" alt="logo" ng-show="&#39;000webhost&#39; == user.config.theme">File Manager</h3>
